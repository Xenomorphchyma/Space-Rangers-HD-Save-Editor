...
Open-source редактор сохранений **Space Rangers HD: A War Apart**
...
Скрипт сверяет SHA-256 EXE с `release\manifest.json` и создаёт в каталоге
`release` минимальный архив с редактором, README и лицензией.
...
Идея проекта и основной набор функций основаны на редакторе
[Cassandra v1.11](https://github.com/indiemagpie/Cassandra) от `indiemagpie`.
Для совместимости исследовались формат SAV и наблюдаемое поведение Cassandra.

Это отдельная open-source реализация с собственной кодовой базой, переработанным
интерфейсом и дополнительными улучшениями. Автор проекта — `Xenomorphchyma`;
авторство оригинальной Cassandra принадлежит её создателю. Подробнее:
[NOTICE.md](NOTICE.md).
